...
cog_x = float(argvs[1]) * 0.001
cog_y = float(argvs[2]) * 0.001
cog_z = float(argvs[3]) * 0.001
i_xx = float(argvs[4])
i_yy = float(argvs[5])
i_zz = float(argvs[6])
i_xy = -float(argvs[7])
...
print(
    ...
    % (cog_x, cog_y, cog_z, mass, cog_i_xx, cog_i_yy, cog_i_zz, cog_i_xy, cog_i_xz, cog_i_yz)
)
