...
def main(file_path):
    ...
    data_servo_angle = data[
        [
            "__time",
            "/beetle1/joint_states/gimbal1/position",
            "/beetle1/joint_states/gimbal2/position",
            "/beetle1/joint_states/gimbal3/position",
            "/beetle1/joint_states/gimbal4/position",
        ]
    ]
    ...
    def interp_df(source_df, cols):
        ...
        for c in cols:
            out[c] = np.interp(inter_time, source_df["__time"].to_numpy(), source_df[c].to_numpy())
